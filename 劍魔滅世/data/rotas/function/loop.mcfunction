...
execute in game_map:realm_of_time_and_space positioned 1 55 -5 as @a[dx=2,dy=3] if dimension game_map:realm_of_time_and_space run function rotas:inventory/out

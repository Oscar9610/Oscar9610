...
execute unless entity @s[tag=su.4.1] positioned ~-0.5 ~-0.5 ~-0.5 if entity @p[gamemode=!spectator,dx=0,dy=0,dz=0] run function monsters:su/4/self/1

execute if entity @s[tag=su.4.1] positioned as @p[tag=su.4.2] run tp @s ~ ~3 ~

...
execute in game_map:ancient_lorras run spawnpoint @a[distance=..60] -175 264 153
...
kill @e[tag=battle_elf.disaster]

execute positioned -175 264 160 in game_map:ancient_lorras run function monsters:summon/disaster

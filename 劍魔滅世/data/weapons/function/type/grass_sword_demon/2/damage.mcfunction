...
scoreboard players reset @s grass_sword.passive
    ...
    # player
execute as @a[tag=grass_sword.user] at @s run function weapons:type/grass_sword_demon/2/player

tag @s add dmger
execute on attacker run tag @s add atker
scoreboard players operation @p[tag=atker] atk = .grass_sword_passive atk

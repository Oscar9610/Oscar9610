...
# effect
execute if score @s water_sword.passive matches ..9 run scoreboard players add @s water_sword.passive 1
...
execute if score @s water_sword.passive matches ..9 run return fail

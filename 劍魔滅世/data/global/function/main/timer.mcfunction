...
execute as @a[scores={player.out_of_combat_detection=0}] if score #global difficulty matches 1 run effect give @s instant_health 1 0 true
execute as @a[scores={player.out_of_combat_detection=0}] if score #global difficulty matches 1 run effect give @s speed 2 0 true

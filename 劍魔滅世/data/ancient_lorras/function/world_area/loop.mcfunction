...
execute as @a at @s if biome ~ ~ ~ orantes:snow_coverd_land run advancement grant @s only ancient_lorras:world_area/snowy_forest/in
execute as @a at @s unless biome ~ ~ ~ orantes:snow_coverd_land run advancement grant @s only ancient_lorras:world_area/snowy_forest/out

execute as @a at @s if biome ~ ~ ~ orantes:snow_coverd_land_cave run advancement grant @s only ancient_lorras:world_area/snowy_forest/cave/in
execute as @a at @s unless biome ~ ~ ~ orantes:snow_coverd_land_cave run advancement grant @s only ancient_lorras:world_area/snowy_forest/cave/out

execute as @a at @s if biome ~ ~ ~ orantes:southern_cave run advancement grant @s only ancient_lorras:world_area/south_cave/in
execute as @a at @s unless biome ~ ~ ~ orantes:southern_cave run advancement grant @s only ancient_lorras:world_area/south_cave/out

execute as @a at @s if biome ~ ~ ~ orantes:mistveil_mountains run advancement grant @s only ancient_lorras:world_area/mist_mountains/in
execute as @a at @s unless biome ~ ~ ~ orantes:mistveil_mountains run advancement grant @s only ancient_lorras:world_area/mist_mountains/out

execute as @a at @s if biome ~ ~ ~ orantes:memory_hill run advancement grant @s only ancient_lorras:world_area/memory_hill/in
execute as @a at @s unless biome ~ ~ ~ orantes:memory_hill run advancement grant @s only ancient_lorras:world_area/memory_hill/out

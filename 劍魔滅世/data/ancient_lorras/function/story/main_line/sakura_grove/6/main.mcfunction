...
execute if score .main_line ancient_lorras.story matches 65 run tellraw @a[distance=..16] {"text":"［艾米］你們已經去過洞穴了嗎?"}
execute if score .main_line ancient_lorras.story matches 66 run tellraw @a[distance=..16] [{"text":"［艾米］那邊發生什麼事了"}]
execute if score .main_line ancient_lorras.story matches 67 run tellraw @a[distance=..16] [{"text":"［小雪］深淵在洞穴日漸變強"}]
execute if score .main_line ancient_lorras.story matches 68 run tellraw @a[distance=..16] [{"text":"［希爾］我們在洞穴偶遇了小雪，她在那邊救助傷員"}]
execute if score .main_line ancient_lorras.story matches 69 run tellraw @a[distance=..16] [{"text":"［艾米］原來是這樣"}]
execute if score .main_line ancient_lorras.story matches 70 run tellraw @a[distance=..16] [{"text":"［艾米］深淵的力量又變強了"}]
execute if score .main_line ancient_lorras.story matches 71 run tellraw @a[distance=..16] [{"text":"［艾米］這一帶可能不太安全了"}]
execute if score .main_line ancient_lorras.story matches 72 run tellraw @a[distance=..16] [{"text":"［艾米］如果可以的話，希望你們能夠去找到幕後的根源"}]
execute if score .main_line ancient_lorras.story matches 73 run tellraw @a[distance=..16] [{"text":"［希爾］沒問題啦，我跟旅行者可是非常要好的搭檔"}]
execute if score .main_line ancient_lorras.story matches 74 run tellraw @a[distance=..16] [{"text":"［艾米］感謝你們，如果有什麼需要的物品附近的商店可能會有"}]

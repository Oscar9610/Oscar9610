...
execute if score .main_line ancient_lorras.story matches 72 run tellraw @a[distance=..16] {"text":"［希爾］小雪！我跟旅行者把所有傷員都帶回來了！"}
...
execute if score .main_line ancient_lorras.story matches 76 run tellraw @a[distance=..16] [{"text":"［希爾］剛好時間不多了"}]
execute if score .main_line ancient_lorras.story matches 77 run tellraw @a[distance=..16] [{"text":"［希爾］我們回去櫻花林說明洞穴的事情吧！"}]

...
execute if score .main_line ancient_lorras.story matches 54 run tellraw @a {"text":"［你］都清理完畢了！"}
...
execute if score .main_line ancient_lorras.story matches 56 run scoreboard players set .main_line ancient_lorras.story 71

advancement revoke @a only world_area:orantes/orantes_city/in
advancement revoke @a only world_area:orantes/land_of_trial/in
advancement revoke @a only world_area:orantes/corrosion_of_conformity/in

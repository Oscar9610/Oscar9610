...
execute if score .main world_tree.story matches 20 as @a run tellraw @s {"translate":"story.skip","fallback": "【SKIP】(點擊跳過劇情對話) ","color":"light_purple","clickEvent":{"action":"run_command","value":"/execute if score .main world_tree.story matches 14..21 run scoreboard players set .main world_tree.story 13"}}
execute if score .main world_tree.story matches 20 run scoreboard players set #spaceship global.advancements 1
execute if score .main world_tree.story matches 20 run tellraw @a {"translate":"world_tree.story.1","fallback": "［旁白］ 世界即將毀滅"}
execute if score .main world_tree.story matches 20 run effect give @a minecraft:invisibility 100 255 true
execute if score .main world_tree.story matches 19 run tellraw @a {"translate":"world_tree.story.2","fallback": "［旁白］ 深淵的力量正在侵蝕著世界的每個角落"}
execute if score .main world_tree.story matches 18 run tellraw @a {"translate":"world_tree.story.3","fallback": "［旁白］ 守護世界千年的世界樹，也即將被深淵擊倒"}
execute if score .main world_tree.story matches 17 run tellraw @a {"translate":"world_tree.story.4","fallback": "［旁白］ 世界的守護者們，正在嘗試為這個世界做出最後的抗爭"}
execute if score .main world_tree.story matches 16 run tellraw @a {"translate":"world_tree.story.5","fallback": "［旁白］ 可惜，為時已晚"}
execute if score .main world_tree.story matches 15 run tellraw @a {"translate":"world_tree.story.6","fallback": "［旁白］ 深淵過於強大"}
execute if score .main world_tree.story matches 14 run tellraw @a {"translate":"world_tree.story.7","fallback": "［旁白］ 於是，兩位守護者決定借用世界樹僅存的力量創造了你"}
...
execute if score .main world_tree.story matches 13 run tellraw @a {"translate":"story.skip","fallback": "【SKIP】(點擊跳過劇情對話) ","color":"light_purple","clickEvent":{"action":"run_command","value":"/execute if score .main world_tree.story matches 1..13 run scoreboard players set .main world_tree.story 1"}}
execute if score .main world_tree.story matches 13 run tellraw @a {"translate":"world_tree.story.8","fallback": "［旁白］你甦醒於世界樹下"}
execute if score .main world_tree.story matches 12 run tellraw @a {"translate":"world_tree.story.9","fallback": "［旁白］守護者們說..."}
execute if score .main world_tree.story matches 11 run tellraw @a {"translate":"world_tree.story.10","fallback": "［瑪莎］世界即將迎來毀滅"}
execute if score .main world_tree.story matches 10 run tellraw @a {"translate":"world_tree.story.11","fallback": "［瑪莎］孩子，你是拯救世界的唯一希望"}
execute if score .main world_tree.story matches 9 run tellraw @a {"translate":"world_tree.story.12","fallback": "［瑪莎］深淵力量正在侵蝕世界"}
execute if score .main world_tree.story matches 8 run tellraw @a {"translate":"world_tree.story.13","fallback": "［瑪莎］為了拯救世界，我將會把你送往其他的星球"}
execute if score .main world_tree.story matches 7 run tellraw @a {"translate":"world_tree.story.14","fallback": "［瑪莎］深淵會侵蝕他能侵蝕的任何東西"}
execute if score .main world_tree.story matches 6 run tellraw @a {"translate":"world_tree.story.15","fallback": "［阿斯卡］包括我們的力量"}
execute if score .main world_tree.story matches 5 run tellraw @a {"translate":"world_tree.story.16","fallback": "［阿斯卡］它能穿越各個星球並蔓延到不同宇宙星球裡"}
execute if score .main world_tree.story matches 4 run tellraw @a {"translate":"world_tree.story.17","fallback": "［阿斯卡］必須在他毀滅世界前，盡速消滅"}
execute as @a if score .main world_tree.story matches 3 run tellraw @s [{"translate":"world_tree.story.18","fallback": "［阿斯卡］我知道你能做到"}]
execute if score .main world_tree.story matches 2 run tellraw @a {"translate":"world_tree.story.19","fallback": "［阿斯卡］堅持下去，相信路上遇到的夥伴，互相幫助"}
execute if score .main world_tree.story matches 1 run tellraw @a {"text":"\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n"}
execute if score .main world_tree.story matches 1 run tellraw @a {"translate":"world_tree.story.20","fallback": "［阿斯卡］再見了，好好活下去！"}

...
# execute in game_map:orantes positioned -7 61 93 as @a[distance=..8] if score rotas._chapter_2 spaceship.story matches 3 run scoreboard players set #rotas.chapter_2 global.advancements 1

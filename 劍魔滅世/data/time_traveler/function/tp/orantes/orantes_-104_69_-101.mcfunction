#腐蝕之境
execute in game_map:orantes as @s[scores={orantes_-104_69_-101=1,disable.tp_book=0}] if score disable.tp_book global.main matches 0 run tp @s -57 60 -211 65 -5

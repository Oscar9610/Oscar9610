#試煉之地
execute in game_map:orantes as @s[scores={orantes_12_62_-73=1,disable.tp_book=0}] if score disable.tp_book global.main matches 0 run tp @s -172 106 323 0 0
execute in game_map:orantes as @s[scores={orantes_12_62_-73=0,disable.tp_book=0}] run tellraw @s [{"text":"目標區域未解鎖","bold": true,"color": "red"}]

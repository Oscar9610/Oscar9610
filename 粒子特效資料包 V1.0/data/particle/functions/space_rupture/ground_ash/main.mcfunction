...
# particle
execute if score @s particle.space_rupture matches 0..6 run particle minecraft:dust 0.984 0.549 1 3 ~ ~ ~ 0 0 0 0 0 force
execute if score @s particle.space_rupture matches 6..12 run particle minecraft:dust 0.529 0.267 0.745 3 ~ ~ ~ 0 0 0 0 0 force
execute if score @s particle.space_rupture matches 13.. run particle minecraft:dust 0.22 0.302 0.624 3 ~ ~ ~ 0.5 0 0.5 0 1 force
execute if score @s particle.space_rupture matches 13.. run particle minecraft:dust 0.529 0.267 0.745 3 ^ ^ ^-1 0.5 0 0.5 0 1 force

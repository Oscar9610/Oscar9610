#偵測所有玩家擁有 水鏡之光(武器) 數量
execute store result score water_sword_demon global.main run clear @a carrot_on_a_stick{water_sword_demon:1b} 0
...
execute if score water_sword_demon global.main matches 2.. run clear @r carrot_on_a_stick{water_sword_demon:1b} 1

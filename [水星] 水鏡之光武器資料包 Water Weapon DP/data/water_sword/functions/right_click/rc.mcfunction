...
execute if score #temp global.main matches 1 run scoreboard players set #temp global.main 0
...
execute if score #temp global.main matches 2 run scoreboard players set #temp global.main 0
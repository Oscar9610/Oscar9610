...
clear @s
item replace entity @s armor.chest with minecraft:elytra[unbreakable={show_in_tooltip:false},enchantments={levels:{"minecraft:binding_curse":1}}]
item replace entity @s weapon.offhand with firework_rocket[max_stack_size=99,fireworks={flight_duration:1},custom_data={disable_drop:1b}] 1

#魅影洞穴
execute in game_map:orantes as @s[scores={orantes_-122_67_91=1,disable.tp_book=0}] if score disable.tp_book global.main matches 0 run tp @s -122 67 91 -15 0
execute in game_map:orantes as @s[scores={orantes_-122_67_91=1,disable.tp_book=0}] if score disable.tp_book global.main matches 0 run function players:update_pos

...
execute in game_map:orantes as @p[scores={orantes_-17_62_16=1,disable.tp_book=0}] if score disable.tp_book global.main matches 0 run function players:update_pos

#奧蘭蒂斯平原
execute in game_map:spaceship_interior as @p[scores={spaceship_0_61_-51=1,disable.tp_book=0}] if score disable.tp_book global.main matches 0 run tp @p 0 56 0 -90 0

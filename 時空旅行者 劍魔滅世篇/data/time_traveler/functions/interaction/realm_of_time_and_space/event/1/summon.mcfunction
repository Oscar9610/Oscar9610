execute in game_map:realm_of_time_and_space run summon interaction 87 74 79 {Tags:["rotas.event.interaction.1","rotas.event.1"],width:1,height:2}
...
function time_traveler:interaction/realm_of_time_and_space/event/1/1

scoreboard players set #rotas.event.interaction.1 orantes.story 0
scoreboard players set #rotas.event.interaction.1 orantes.global.main 0

#function time_traveler:interaction/realm_of_time_and_space/event/1/summon
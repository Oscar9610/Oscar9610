...
scoreboard objectives add p1_double_sword_fire_dot dummy "P1熾熱雙股劍dot持續時間"
scoreboard objectives add p2_double_sword_fire_dot dummy "P2熾熱雙股劍dot持續時間"
scoreboard objectives add p3_double_sword_fire_dot dummy "P3熾熱雙股劍dot持續時間"
scoreboard objectives add p4_double_sword_fire_dot dummy "P4熾熱雙股劍dot持續時間"
...
scoreboard players set .double_sword_fire_dot percentage 50

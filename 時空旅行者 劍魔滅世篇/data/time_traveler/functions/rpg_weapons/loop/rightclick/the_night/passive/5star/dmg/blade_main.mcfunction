scoreboard players add @s the_night_charge_timer 20
...
# particle
execute as @e[type=block_display,tag=rotater] at @s run function time_traveler:rpg_weapons/loop/rightclick/the_night/passive/5star/range_particle2

# reset
execute if score @s the_night_charge_timer matches 360.. run function time_traveler:rpg_weapons/loop/rightclick/the_night/passive/5star/dmg/clear

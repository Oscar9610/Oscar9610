...
execute as @a[scores={the_night_time=1}] run effect give @s resistance 1 255 true
execute as @a[scores={the_night_time=1}] run effect give @s fire_resistance 1 255 true
execute as @a[scores={the_night_time=1}] run effect give @s slowness 1 255 true
execute as @a[scores={the_night_time=1}] run effect give @s jump_boost 1 255 true

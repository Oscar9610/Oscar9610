...
tag @s add night_open_5_temp
effect give @e[distance=..5,type=!player] slowness 4 255 true
execute as @s[tag=night_open_5] at @s run function time_traveler:screen_amimation/the_night_5star/start

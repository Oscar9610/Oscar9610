execute positioned -64 63 5 in game_map:orantes as @a unless entity @a[distance=..30] if score #orantes_1.mw.rt orantes.global.main matches 0 run function time_traveler:monster_wave/orantes/1/reset
...
execute positioned -64 63 5 in game_map:orantes if entity @a[distance=..30] if score #orantes_1.mw.rt orantes.global.main matches 0 run schedule function time_traveler:monster_wave/orantes/1/loop 1t
...
execute as @e[tag=orantes_main_battle] at @s run particle minecraft:dust{color:[1.000,0.000,0.000],scale:1.5} ^ ^2 ^30 0 0 0 0 5 force

execute as @e[tag=orantes_main_battle] at @s run particle minecraft:dust{color:[1.000,0.000,0.000],scale:1.5} ^ ^2 ^-30 0 0 0 0 5 force
execute as @e[tag=orantes_main_battle] at @s run particle minecraft:dust{color:[1.000,0.000,0.000],scale:1.5} ^1 ^2 ^-30 0 0 0 0 5 force
execute as @e[tag=orantes_main_battle] at @s run particle minecraft:dust{color:[1.000,0.000,0.000],scale:1.5} ^-1 ^2 ^-30 0 0 0 0 5 force
execute as @e[tag=orantes_main_battle] at @s run particle minecraft:dust{color:[1.000,0.000,0.000],scale:1.5} ^1 ^2 ^30 0 0 0 0 5 force
execute as @e[tag=orantes_main_battle] at @s run particle minecraft:dust{color:[1.000,0.000,0.000],scale:1.5} ^-1 ^2 ^30 0 0 0 0 5 force

...
schedule function time_traveler:monster_wave/orantes/realm_of_time_and_space/1/summon 1t

kill @e[type=!player,tag=orantes.rotas.1.monster.wave]
schedule function time_traveler:monster_wave/orantes/realm_of_time_and_space/1/loop 1t
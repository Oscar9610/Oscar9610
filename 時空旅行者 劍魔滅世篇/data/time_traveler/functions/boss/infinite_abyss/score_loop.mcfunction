#施法開始
execute as @s[scores={boss.skill.cast.cd=0}] at @s run function time_traveler:boss/infinite_abyss/cast

#施法中
execute as @s[scores={boss.skill.casting=1..}] at @s run function time_traveler:boss/infinite_abyss/casting

#施法結束
execute as @s[scores={boss.skill.casting=0}] at @s run function time_traveler:boss/infinite_abyss/castend

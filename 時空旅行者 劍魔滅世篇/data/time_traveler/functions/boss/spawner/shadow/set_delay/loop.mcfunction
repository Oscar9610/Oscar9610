...
execute positioned 0 63 0 in game_map:shadow_arena if entity @a[distance=..60] unless entity @e[tag=shadow,distance=..60] if score #automations.orantes.shadow automations.boss_time matches 0 run function time_traveler:boss/shadow/summon

...
function time_traveler:boss/infinite_abyss/tag_loop
...
execute as @e[scores={boss.skill.cast.cd=20}] at @s run particle minecraft:dust_color_transition 1 1 0 1 1 1 1 ~ ~ ~ 0.1 10 0.1 0 500 force

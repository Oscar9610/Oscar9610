execute in game_map:orantes positioned -72 74 14 if loaded -72 74 14 if score rotas._chapter_2 spaceship.story matches 44.. if entity @a[distance=8..] if score #fx.tp_door orantes.global.main matches 1 run function rotas:fx/tp_door/clear
execute in game_map:orantes positioned -72 74 14 if loaded -72 74 14 if score rotas._chapter_2 spaceship.story matches 44.. if entity @a[distance=8..] if score #fx.tp_door orantes.global.main matches 1 run scoreboard players set #fx.tp_door orantes.global.main 0

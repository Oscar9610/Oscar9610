...
execute if score #lena orantes.story matches 10 run tellraw @p {"text":"【我沒拿到傳送書，可以跟你拿一本傳送書嗎?】(點擊獲取傳送書)","bold":true,"color":"dark_green","clickEvent":{"action":"run_command","value":"/function time_traveler:rpg_items/get/tp_book"}}

...
execute positioned -189 59 -7 in game_map:orantes if score .main_line orantes.story matches 36 run function time_traveler:story/orantes/main_line/rescue_statement/summon_statement_2

...
execute positioned -189 59 -7 in game_map:orantes if score .main_line orantes.story matches 56 as @a[distance=..45] run function time_traveler:rpg_weapons/get/sword/wind_sword

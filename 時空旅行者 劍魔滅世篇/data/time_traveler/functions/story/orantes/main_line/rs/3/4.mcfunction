#rs  = 【主線】拯救陳述
execute if score .main_line orantes.story matches 30 run effect give @e[type=armor_stand,tag=walk,tag=statement] glowing 5 1 true
execute if score .main_line orantes.story matches 30 run tellraw @a[tag=statement_walk] {"text":"［希爾］陳述你別跑那麼快，我們跟不上你的速度"}

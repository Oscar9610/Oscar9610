...
#台詞
execute if score .main_line orantes.story matches 13 run title @s title {"text":"\uE000"}
execute if score .main_line orantes.story matches 13 run title @s times 10 40 20
execute if score .main_line orantes.story matches 13 run tag @s add rescue_statement.smooth_camera
...
execute if score .main_line orantes.story matches 13 run tellraw @s {"text":"［???］別過來！我警告你們！不然我就要攻擊了！"}
execute if score .main_line orantes.story matches 13 run function time_traveler:players/player_restore_state

execute if score .main_line orantes.story matches 14 run tag @s remove rescue_statement.smooth_camera
...
execute if score .main_line orantes.story matches 14 run tellraw @s {"text":"(深淵怪物無視小孩的警告慢慢靠近小孩)","color":"red"}
execute if score .main_line orantes.story matches 15 run tellraw @s {"text":"［希爾］那邊有一個小孩被深淵怪物包圍了！"}
execute if score .main_line orantes.story matches 16 run tellraw @s {"text":"［希爾］快來幫忙！","color": "white","extra":[{"selector":"@s","color":"green"}]}

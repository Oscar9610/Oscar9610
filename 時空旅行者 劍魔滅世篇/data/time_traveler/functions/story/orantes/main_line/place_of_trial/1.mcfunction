...
execute positioned 6 63 177 in game_map:orantes as @a[tag=!op,distance=..18] if score .main_line orantes.story matches 109 run tellraw @s {"text":"［爺爺］在你們擊敗保護封印的守護者後"}

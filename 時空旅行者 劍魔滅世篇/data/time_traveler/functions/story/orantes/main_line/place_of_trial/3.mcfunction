...
execute positioned 11 62 -125 in game_map:orantes if score .main_line orantes.story matches 119 as @r[distance=..100] run function time_traveler:rpg_weapons/get/sword/water_sword_demon

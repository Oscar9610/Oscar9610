...
execute if score #global core_stage matches 1 if score .kill_potion core_stage matches 1 if score .kill_shadow core_stage matches 1 if score .kill_storm_keeper core_stage matches 1 run function time_traveler:story/orantes/main_line/core/close

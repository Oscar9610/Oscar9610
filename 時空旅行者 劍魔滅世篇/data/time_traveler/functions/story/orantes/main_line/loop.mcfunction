...
execute positioned -64 63 5 in game_map:orantes as @a[distance=..14] at @s if score .main_line orantes.global.main matches 3 run function time_traveler:story/orantes/main_line/rescue_statement/start

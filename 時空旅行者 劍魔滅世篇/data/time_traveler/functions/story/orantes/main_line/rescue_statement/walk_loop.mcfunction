...
execute as @e[tag=walk,tag=statement,tag=!automated_walking] positioned -107 63 17 if entity @s[distance=..3] run function time_traveler:story/orantes/main_line/rescue_statement/4
...
execute as @e[tag=walk,tag=statement,tag=!automated_walking] at @s if entity @a[distance=..5] run function time_traveler:story/orantes/main_line/rescue_statement/walking

execute as @e[tag=automated_walking] at @s run function time_traveler:story/orantes/main_line/rescue_statement/automated_walking

kill @e[tag=walk,tag=statement,scores={duration=200..}]

execute as @e[tag=walk,tag=statement,tag=automated_walking] at @s positioned -180 61 -10 if entity @s[distance=..1] run schedule function time_traveler:story/orantes/main_line/rescue_statement/remove_walk_loop 2t
execute as @e[tag=walk,tag=statement,tag=automated_walking] at @s positioned -180 61 -10 if entity @s[distance=..1] run kill @s


schedule function time_traveler:story/orantes/main_line/rescue_statement/walk_loop 1t
...
execute if score .main_line orantes.story matches 34 as @a at @s run function time_traveler:story/orantes/main_line/rescue_statement/task_end_text
...
execute if score .main_line orantes.story matches 34 run function time_traveler:story/orantes/main_line/rescue_statement/end
execute if score .main_line orantes.story matches 34 in game_map:orantes run function time_traveler:story/orantes/main_line/rescue_statement/summon_statement_2

execute if score .main_line orantes.story matches 30..34 run scoreboard players add .main_line orantes.story 1

execute if score .main_line orantes.story matches 30..34 run schedule function time_traveler:story/orantes/main_line/rescue_statement/4 4s
...
execute if score #rotas.event.interaction.2 orantes.story matches 6 run tellraw @s {"text":"【抽取！隨機獲得1~5星的武器 (魔劍除外)】","bold":true,"color":"dark_aqua","clickEvent":{"action":"run_command","value":"/execute if score #rotas.event.interaction.2 orantes.story matches 7 run function time_traveler:story/orantes/realm_of_time_and_space/event/2/choose_1"}}
execute if score #rotas.event.interaction.2 orantes.story matches 6 run tellraw @s {"text":"【不抽！感覺是詐騙！】","bold":true,"color":"dark_aqua","clickEvent":{"action":"run_command","value":"/execute if score #rotas.event.interaction.2 orantes.story matches 7 run function time_traveler:story/orantes/realm_of_time_and_space/event/2/choose_2"}}

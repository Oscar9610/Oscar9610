...
execute if score #rotas.event.interaction.1 orantes.story matches 10 run function time_traveler:monster_wave/orantes/realm_of_time_and_space/1/open
...
execute if score #rotas.event.interaction.1 orantes.story matches 12 run function time_traveler:story/orantes/realm_of_time_and_space/event/1/reset

...
execute if score #lost_guardian_task_1 orantes.story matches 5.. if score #aldon_1 orantes.story matches 3.. run schedule function time_traveler:story/orantes/branch_line/lost_guardian/loop_delete_sword 1t

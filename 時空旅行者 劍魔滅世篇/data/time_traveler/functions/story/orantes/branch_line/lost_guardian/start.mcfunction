...
execute in game_map:orantes positioned 120 64 -93 as @a[distance=..12] run effect give @s slowness 10 8 true
execute in game_map:orantes positioned 120 64 -93 as @a[distance=..12] run effect give @s jump_boost 10 255 true

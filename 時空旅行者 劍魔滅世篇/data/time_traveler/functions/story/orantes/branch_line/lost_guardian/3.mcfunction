...
execute if score .lost_guardian orantes.story matches 14 in game_map:orantes run summon minecraft:armor_stand 33.75 42.5 -60.0 {DisabledSlots:4144959,Tags:["reina_sword.interaction","reina_sword"],NoGravity: 1b, Brain: {memories: {}}, HurtByTimestamp: 0, Attributes: [{Base: 0.699999988079071d, Name: "minecraft:generic.movement_speed"}], Invulnerable: 1b, FallFlying: 0b, ShowArms: 1b, PortalCooldown: 0, AbsorptionAmount: 0.0f, FallDistance: 0.0f, DeathTime: 0s, Pose: {RightArm: [90.0f, 180.0f, 0.0f]}, Invisible: 1b, Motion: [0.0d, 0.0d, 0.0d], Small: 0b, Health: 20.0f, Air: 300s, OnGround: 1b, Rotation: [0.0f, 0.0f], HandItems: [{id: "minecraft:carrot_on_a_stick", Count: 1b, tag: {CustomModelData: 17, Damage: 0}}, {}], Fire: -1s, ArmorItems: [{}, {}, {}, {}], NoBasePlate: 1b, HurtTime: 0s}

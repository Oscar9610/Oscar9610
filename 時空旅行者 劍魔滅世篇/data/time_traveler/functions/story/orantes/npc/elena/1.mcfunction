...
execute positioned 146.50 63.00 -88.50 in game_map:orantes as @a[distance=..12] if score #elena orantes.story matches 5 run scoreboard players set #lost_guardian global.advancements 2
#loop

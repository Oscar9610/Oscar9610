...
execute as @a at @s if dimension game_map:spaceship_interior if score @s music.spaceship matches 0 if score .time_and_space_journey_mercury_chapter_2 spaceship.global.main matches ..3 run function time_traveler:msuic/escaping_gravity/start
execute as @a at @s unless dimension game_map:spaceship_interior if score @s music.spaceship matches 1.. if score .time_and_space_journey_mercury_chapter_2 spaceship.global.main matches ..3 run function time_traveler:msuic/escaping_gravity/reset

...
title @s subtitle [{"text":"༄Storm Cave༄","italic":true,"underlined":true,"color":"aqua"}]
title @s times 20 20 20
execute as @s[scores={orantes_134_64_64=0}] run tellraw @s [{"text":"已解鎖新傳送點【風暴洞穴】","color":"green"}]

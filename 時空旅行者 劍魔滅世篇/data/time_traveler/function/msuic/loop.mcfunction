#奧蘭蒂斯城 背景音樂
execute as @a at @s if biome ~ ~ ~ orantes:rain_city_1 if score @s music.orantes_city matches 0 unless score #music.rain_city global.main matches 3 store result score #music.rain_city global.main run random value 1..2
...
execute as @a at @s if biome ~ ~ ~ orantes:rain_city_1 if score @s music.orantes_city matches 0 if score #music.rain_city global.main matches 3 run function time_traveler:msuic/orantes_city_music/3/start

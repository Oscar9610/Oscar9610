...
execute as @a[scores={music.orantes_city=1,music.orantes_city.rdm=1}] run function time_traveler:msuic/orantes_city_music/1/start
execute as @a[scores={music.orantes_city=1,music.orantes_city.rdm=2}] run function time_traveler:msuic/orantes_city_music/2/start
execute as @a[scores={music.orantes_city=1,music.orantes_city.rdm=3}] run function time_traveler:msuic/orantes_city_music/3/start

#============================================================================================================================================================================

# ---試煉之地--- #

execute as @a[scores={music.place_of_trial=1}] run function time_traveler:msuic/land_of_trial/start

#============================================================================================================================================================================

# ---地圖大廳--- #

execute as @a[scores={music.map_hall=1}] run function time_traveler:msuic/map_hall/start

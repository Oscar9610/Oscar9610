...
# sickle
summon item_display ~ ~2 ~ {Tags:[sickle2,Duration],item:{id:"minecraft:iron_sword",Count:1b,components:{custom_model_data:3}},item_display:"head",teleport_duration:1,transformation:[2.1213f,-2.1213f,0.0000f,0.0000f,0.0000f,-0.0000f,-1.0000f,0.0000f,2.1213f,2.1213f,0.0000f,1.5000f,0.0000f,0.0000f,0.0000f,1.0000f]}

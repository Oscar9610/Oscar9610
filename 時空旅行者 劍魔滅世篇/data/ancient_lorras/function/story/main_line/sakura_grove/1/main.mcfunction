...
execute if score .main_line ancient_lorras.story matches 19 run tellraw @a[distance=..16] [{"text":"［櫻花林村長］關於草之魔劍的訊息嗎? 恩...在古羅拉斯曾經有這麼一個傳說"}]
execute if score .main_line ancient_lorras.story matches 20 run tellraw @a[distance=..16] [{"text":"［櫻花林村長］","color": "white"},{"text":"「我們的家園正在因為深淵力量的侵蝕逐漸地消散，唯有將希望匯聚在一起，才能夠讓一切恢復如初」","color":"gold","bold":true}]
execute if score .main_line ancient_lorras.story matches 21 run tellraw @a[distance=..16] [{"text":"［櫻花林村長］正好最近古羅拉斯出現了不少怪物襲擊的事件"}]
execute if score .main_line ancient_lorras.story matches 22 run tellraw @a[distance=..16] [{"text":"［櫻花林村長］據狐族傷員說最近古羅拉斯洞穴出現神秘的洞穴"}]
execute if score .main_line ancient_lorras.story matches 23 run tellraw @a[distance=..16] [{"text":"［櫻花林村長］很多狐族基於好奇心去進入洞穴"}]
execute if score .main_line ancient_lorras.story matches 24 run tellraw @a[distance=..16] [{"text":"［櫻花林村長］但是洞穴裡很多怪物，許多狐族村民受困於此"}]
...
execute if score .main_line ancient_lorras.story matches 27 run tellraw @a[distance=..16] [{"text":"［希爾］那關於洞穴的地點在哪？"}]
execute if score .main_line ancient_lorras.story matches 28 run tellraw @a[distance=..16] [{"text":"［櫻花林村長］洞穴位於"},{"text":"櫻花林西方的草原附近","color":"gold"},{"text":" 在去之前或許你們需要一些資源"}]
...
execute if score .main_line ancient_lorras.story matches 29 run tellraw @a[distance=..16] [{"text":"［櫻花林村長］在櫻花林裡你可以購買一些這裡的裝備來提升戰力"}]

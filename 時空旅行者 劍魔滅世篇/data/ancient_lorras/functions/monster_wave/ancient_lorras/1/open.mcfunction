...
scoreboard players set .main_line ancient_lorras.global.main 2
function ancient_lorras:monster_wave/ancient_lorras/1/result/wave_reset
...
# range
execute as @e[type=marker,tag=ancient_lorras_main_battle,limit=1] at @s anchored eyes run function ancient_lorras:monster_wave/ancient_lorras/1/range
...
schedule function ancient_lorras:monster_wave/ancient_lorras/1/summon/layout 1t
schedule function ancient_lorras:monster_wave/ancient_lorras/1/loop 1t

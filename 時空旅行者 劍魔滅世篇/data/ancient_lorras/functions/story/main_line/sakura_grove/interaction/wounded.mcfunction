...
execute as @e[tag=wounded.act] at @s if data entity @s interaction.timestamp if score .main_line ancient_lorras.story matches 57..70 run function ancient_lorras:story/main_line/sakura_grove/5/main

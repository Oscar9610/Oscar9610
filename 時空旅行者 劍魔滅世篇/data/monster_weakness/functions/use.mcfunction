...
execute anchored eyes positioned ^ ^ ^2 as @e[type=#time_traveler:monsters,nbt={HurtTime:10s},sort=nearest,limit=1] at @s anchored eyes run function monster_weakness:critical_fx
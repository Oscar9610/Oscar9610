...
item replace entity @s armor.chest with diamond_chestplate[trim={pattern:'atar_light_trim',material:'atar_light_material'}]
item replace entity @s armor.legs with diamond_leggings[trim={pattern:'atar_light_trim',material:'atar_light_material'}]

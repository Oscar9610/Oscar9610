...
execute in game_map:realm_of_time_and_space run summon interaction 87 74 79 {PersistenceRequired:1,Tags:["rotas.event.interaction.2","rotas.event.2"],width:1,height:2}

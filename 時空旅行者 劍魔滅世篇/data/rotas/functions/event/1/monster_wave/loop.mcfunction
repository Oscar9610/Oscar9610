...
execute positioned 87 73 79 in game_map:realm_of_time_and_space as @e[type=!player,tag=rotas_event_1.monster_wave,distance=30..] at @s run tp @s ~ ~ ~ facing -64 63 5
execute positioned 87 73 79 in game_map:realm_of_time_and_space as @e[type=!player,tag=rotas_event_1.monster_wave,distance=30..] at @s anchored feet run tp @s ^ ^0.5 ^1

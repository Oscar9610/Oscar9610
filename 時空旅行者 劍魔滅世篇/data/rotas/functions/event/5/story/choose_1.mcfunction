...
execute as @a if dimension game_map:realm_of_time_and_space if score #rotas.event.act.5 rotas.story matches 11 run function rotas:event/5/rdm_get_weapons

...
execute if score #event.4.rdm_get_weapons rotas.global.main matches 3 run function time_traveler:rpg_weapons/get/double_weapons/double_sword_fire
execute if score #event.4.rdm_get_weapons rotas.global.main matches 4 run function time_traveler:rpg_weapons/get/double_weapons/double_sword_water
execute if score #event.4.rdm_get_weapons rotas.global.main matches 5 run function time_traveler:rpg_weapons/get/sickle/noob_sickle
execute if score #event.4.rdm_get_weapons rotas.global.main matches 6 run function time_traveler:rpg_weapons/get/sword/noob_sword
execute if score #event.4.rdm_get_weapons rotas.global.main matches 7 run function time_traveler:rpg_weapons/get/sword/the_night_sword_3star

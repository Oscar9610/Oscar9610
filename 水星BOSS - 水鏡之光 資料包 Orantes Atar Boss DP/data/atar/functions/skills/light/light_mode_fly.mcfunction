execute as @e[tag=light_mode] at @s if score light_sky_blade_fly atar_skills matches 10 run function atar:skills/light/fly_particle
...
execute as @e[tag=light_mode] at @s if score light_sky_blade_fly atar_skills matches 235 positioned ~ ~-20.5 ~ run function atar:skills/light/fly_particle
